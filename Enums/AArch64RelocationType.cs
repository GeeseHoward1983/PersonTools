namespace PersonalTools.Enums
{
    ...
    internal enum AArch64RelocationType : uint
    {
        ...
        R_AARCH64_JUMP26 = 283,
        R_AARCH64_CALL26 = 284,
        R_AARCH64_LDST16_ABS_LO12_NC = 285,
        R_AARCH64_LDST32_ABS_LO12_NC = 286,
        R_AARCH64_LDST64_ABS_LO12_NC = 287,
        R_AARCH64_MOVW_PREL_G0 = 288,
        R_AARCH64_MOVW_PREL_G0_NC = 289,
        R_AARCH64_MOVW_PREL_G1 = 290,
        R_AARCH64_MOVW_PREL_G1_NC = 291,
        R_AARCH64_MOVW_PREL_G2 = 292,
        R_AARCH64_MOVW_PREL_G2_NC = 293,
        R_AARCH64_MOVW_PREL_G3 = 294,
        R_AARCH64_LDST128_ABS_LO12_NC = 295,
        R_AARCH64_MOVW_GOTOFF_G0 = 296,
        R_AARCH64_MOVW_GOTOFF_G0_NC = 297,
        R_AARCH64_MOVW_GOTOFF_G1 = 298,
        R_AARCH64_MOVW_GOTOFF_G1_NC = 299,
        R_AARCH64_MOVW_GOTOFF_G2 = 300,
        R_AARCH64_MOVW_GOTOFF_G2_NC = 301,
        R_AARCH64_MOVW_GOTOFF_G3 = 302,
        R_AARCH64_GOTREL64 = 303,
        R_AARCH64_GOTREL32 = 304,
        R_AARCH64_GOT_LD_PREL19 = 305,
        R_AARCH64_LD64_GOTOFF_LO15 = 306,
        ...
        R_AARCH64_RELATIVE = 1027,      // Delta(S) + A，对应十六进制0x403
